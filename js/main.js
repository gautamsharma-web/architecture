...
// ================== proeject jsss 
document.addEventListener('DOMContentLoaded', function() {
    // 1. Before vs After Slider Logic
    const slider = document.getElementById('at-slider');
    const beforeImg = document.querySelector('.at-img-before');
    ...
    // 2. Simple Gallery Filter Logic
    const buttons = document.querySelectorAll('.at-filter-btn');
